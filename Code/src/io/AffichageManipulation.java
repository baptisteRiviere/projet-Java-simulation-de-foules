...
public class AffichageManipulation extends JFrame{

	private static final long serialVersionUID = -1055389306516812136L;
	...
	private JPanel contentPane7; //Def d'un sous-corps
	
	private JCheckBox collis = new JCheckBox("Avec Collision"); //Creation d'une boite a check
	private JCheckBox obsSortie = new JCheckBox("Avec un obstacle devant la sortie"); //Creation d'une boite a check
	...
	public AffichageManipulation() {
		...
		contentPane.setLayout(new GridLayout(7,1,10,10)); //Creation d'une grille dans le corps pour l'organisation des composants
		...
		contentPane4.add(obsSortie); //Ajout de la boite a check
		...
		contentPane5.add(collis); //Ajout de la boite a check
		...
		contentPane6.add(Labelnbpers); //Ajout du texte
		contentPane6.add(fieldnbpers); //Ajout de la zone de texte
		...
		contentPane7.setLayout(new BorderLayout(0, 0));
		contentPane7.setLayout(new FlowLayout()); //Organisation des compasants du sous-corps, centré l'un à coté de l'autre
		check.addActionListener(this::Start); //Action du bouton
		contentPane7.add(check); //Ajoute un bouton
	...
	private void Start(ActionEvent event) {
		...
		//Renvoie la fenetre de simulation
			...
			AffichageSimulation frameSimulation = new AffichageSimulation(longeur, largeur, nbprs, collis.isSelected(), obsSortie.isSelected());
